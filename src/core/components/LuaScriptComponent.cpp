...
namespace rosa {
    ...
    auto init_events(sol::state& state) -> void {
        ...
        state["EventKeyboardMods"] = state.create_table_with(
                ...
                "Super", KeyboardModifier::ModifierKeySuper
        );
        ...
        state.new_usertype<rosa::KeyboardEvent>(
                "keyboard",
        ...
        state.new_usertype<rosa::MouseEvent>(
                "mouse",
        ...
        state.new_usertype<rosa::ResizeEvent>(
                "resize",
    ...
    auto init_types(sol::state& state) -> void {
        ...
        state.new_usertype<rosa::Colour>(
                "Colour",
        ...
        state.new_usertype<rosa::Vertex>(
                "Vertex",
        ...
        state.new_usertype<rosa::Entity>(
                "Entity",
        ...
        state.new_usertype<rosa::TransformComponent>(
                "Transform",
        ...
        state.new_usertype<rosa::SpriteComponent>(
                "Sprite",
        ...
        state.new_usertype<rosa::Uuid>(
                "Uuid",
                sol::constructors<rosa::Uuid(std::string)>(),
                "to_string", &rosa::Uuid::toString
        );

        state.new_usertype<rosa::lua_script::CountdownTimer>(
                "Countdown",
